			...
			select: function() {
				...
				f.each(function(e, l) {
					...
					function(e) {
						...
						return layui.each(e,
						function(e, a) {
							0 !== e || a.value ? "optgroup" === a.tagName.toLowerCase() ? t.push("<dt>" + a.label + "</dt>") : t.push('<dd lay-value="' + a.value + '" class="' + (d === a.value ? s: "") + (a.disabled ? " " + u: "") + '">' + (a.getAttribute('lay-text') ? a.getAttribute('lay-text') : a.innerHTML) + "</dd>") : t.push('<dd lay-value="" class="layui-select-tips">' + (a.innerHTML || i) + "</dd>")
						}),
